...
export namespace Prisma {
  ...
  */
  ...
  export type UserOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "clerkId" | "email" | "username" | "name" | "bio" | "image" | "location" | "website" | "createdAt" | "updatedAt", ExtArgs["result"]["user"]>
  ...
  export type FollowsOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"followingId" | "followerId" | "createdAt", ExtArgs["result"]["follows"]>
  ...
  export interface FollowsDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * const followsWithFollowingIdOnly = await prisma.follows.findMany({ select: { followingId: true } })
     * 
     */
     ...
     * })
     * 
     * // Create many Follows and only return the `followingId`
     * const followsWithFollowingIdOnly = await prisma.follows.createManyAndReturn({
     ...
     * })
     * 
     * // Update zero or more Follows and only return the `followingId`
     * const followsWithFollowingIdOnly = await prisma.follows.updateManyAndReturn({
     *   select: { followingId: true },
     *   where: {
     *     // ... provide filter here
     *   },
  ...
  export type NotificationOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "receiverId" | "creatorId" | "postId" | "commentId" | "type" | "createdAt" | "read", ExtArgs["result"]["notification"]>
